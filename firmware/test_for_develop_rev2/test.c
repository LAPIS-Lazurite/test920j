...
#include "..\..\hardware\lazurite_subghz\sub_ghz\phy\phy_ml7396.h"
#include "..\..\hardware\lazurite_subghz\sub_ghz\hwif\hal.h"
#include "..\..\hardware\lazurite_subghz\sub_ghz\hwif\wire0.h"
#include "..\..\hardware\lazurite_subghz\sub_ghz\hwif\spi0.h"
#include "..\..\hardware\lazurite_subghz\sub_ghz\subghz_api.h"
...
//	Serial.println_long(bstop,DEC);
	...
	Wire0.requestFrom(address,qty,bstop);
...
static void wirea(uint8_t** pparam,SUBGHZ_MAC_PARAM* mac)
{
	...
	Print.init(obuf,sizeof(obuf));
	Print.p("wirea,");
	Print.l((long)Wire0.available(),DEC);
	Print.ln();
	// command process
